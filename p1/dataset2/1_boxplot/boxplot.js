function boxplotChart(dataset, myOptions)
{
	...
	var tip = d3.tip()
		...
		.html(function(d)
		{
			...
			return "<span style='color:white;font-size:10px'>" + Object.keys(dataset[0])[column_sample] +
				"</span> <span style='color:red;font-size:10px'>" + d3.format(tooltip_f)(d[keys[column_sample]]) + "</span>";
		});
	//=========================================================================================================================
