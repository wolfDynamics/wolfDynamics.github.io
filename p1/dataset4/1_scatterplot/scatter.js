function scatterChart(dataset, myOptions)
{
	...
	var tip = d3.tip()
		...
		.html(function(d)
		{
			...
			return 	"<span style='color:white;font-size:12px'>" + xLabel + " = " + xValue(d) + "</span>" + "<br/>" +
					"<span style='color:white;font-size:12px'>" + yLabel + " = " + yValue(d) + "</span>" + "<br/>" +
					"<span style='color:white;font-size:12px'>" + keys[column_c] + " = " + d[keys[column_c]] + "</span>" + "<br/>" +
					"<span style='color:white;font-size:12px'>" + "Shot type " + " = " + d.SHOT_TYPE+ "</span>" + "<br/>" +
					"<span style='color:white;font-size:12px'>" + "Missed/Made shot " + " = " + d.EVENT_TYPE + "</span>" + "<br/>" +
					"<span style='color:white;font-size:12px'>" + "Period " + " = " + d.PERIOD + "</span>" + "<br/>" +
					"<span style='color:white;font-size:12px'>" + "Minutes remaining " + " = " + d.MINUTES_REMAINING + "</span>" + "<br/>" +
					"<span style='color:white;font-size:12px'>" + "Seconds remaining " + " = " + d.SECONDS_REMAINING + "</span>";
