function boxplotChart(dataset, myOptions)
{
	...
	var tip = d3.tip()
		...
		.html(function(d)
		{
			return 	"<span style='color:white;font-size:12px'>" + "LOC_X" + " = " + d.LOC_X + "</span>" + "<br/>" +
					"<span style='color:white;font-size:12px'>" + "LOC_Y" + " = " + d.LOC_Y + "</span>" + "<br/>" +
					"<span style='color:white;font-size:12px'>" + "Shot distance " + " = " + d.SHOT_DISTANCE + "</span>" + "<br/>" +
